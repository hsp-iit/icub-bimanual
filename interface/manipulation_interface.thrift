service ManipulationInterface
{
	...
	bool move_hands_to_pose(1:string poseName);                                                 # Move the hands to a pre-defined pose
	
	bool move_hands_to_pose(1:list<double> pose);                                               # Move the hands to a given pose
	
	bool move_joints_to_position(1:string positionName);                                        # Move the joints to (a) predefined configuration(s)
